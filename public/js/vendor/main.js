...
$(document).ready(function () {
    ...
    if ($('#OneImage-popup1').length > 0) {
        $('#OneImage-popup1').magnificPopup({
            items: [
                {
                    src: '../images/home1/fashion-bag.jpg',
                    title: 'New Bags'
                },
            ],
            gallery: {
    ...
    if ($('#Vimeo-popup1, #Vimeo-popup2, #Vimeo-popup3').length > 0) {
        $('#Vimeo-popup1, #Vimeo-popup2, #Vimeo-popup3').magnificPopup({
            items: [
                {
...
// 
    ...
    $('#custom-pattern1').click(function () {
    ...
    $('#custom-pattern2').click(function () {
    ...
    $('#custom-pattern3').click(function () {
    ...
    $('#custom-pattern4').click(function () {
